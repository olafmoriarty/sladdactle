...
function InfoBox(props) {
	...
	const infoboxContents = {
		...
		'personvern': <>
			...
			<p>Det er ingen informasjonskapsler på denne siden, og iallefall ingen sporingsinformasjonskapsler som kan identifisere deg, men Sladdactle lagrer <em>noe</em> informasjon lokalt i nettleseren din, i “localStorage”. Helt nøyaktig lagres to ting, begge for å gi deg en ørlitegrann bedre spillopplevelse:</p>
			<ul>
